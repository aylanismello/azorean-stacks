...
export const PlayerSection = forwardRef<AudioPlayerHandle, PlayerSectionProps>(
  function PlayerSection({ spotifyUrl, audioSrc, compact = false, autoPlay = false, externalPlayButton = false, onStateChange }, ref) {
      ...
      <div className="space-y-1.5">
        ...
        {activeTab === "audio" && hasAudio && (
          <AudioPlayer
            ...
            compact={compact}
            autoPlay={autoPlay}
            externalPlayButton={externalPlayButton}
